    ...
    <nav class="nav">
        ...
        <div class="section d-flex justify-content-center">
            <form class="w-50 mb-5" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="btn col-md-12 p-0 btnsubmit"> <input class="form-control" type="submit" value="S'inscrire"
                        name="submit">
                    <input type="" name="id_service" value="<?php echo $row["id_service"]; ?>">
                </div>
        </div>
        </form>
        </div>
