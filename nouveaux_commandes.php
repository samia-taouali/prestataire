...
if(isset($_POST["valider"])){
    ...
    $sql = "UPDATE commande SET statut_commande = 'Valider' WHERE id_commande = '$id_commande'";
    ...
    $id_commande = $_POST["id_commande"];
    $sql = "UPDATE commande SET statut_commande = 'Rejeter' WHERE id_commande = '$id_commande'";
...
<head>
    ...
    <link rel="stylesheet" href="nouveaux_commandes.css">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-9ndCyUaIbzAi2FUVXJi0CjmCapSmO7SnpJef0486qhLnuZ2cdeRhO02iuK6FUUVM" crossorigin="anonymous">
    <title>nouveaux_commandes</title>
</head>
                                   ...
                                   <div class="card1">
                                        <form action="" method="post">
                                            ...
                                            <div class="buttons">
                                                ...
                                                <input class="btn1" type="submit" name="valider" value="Valider">
                                                <input class="btn2" type="submit" name="rejeter" value="rejeter">
                                            </div>
                                        </form>
                                   </div>
                                <?php
